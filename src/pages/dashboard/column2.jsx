...
export const ColumnItem2 = ({data}) => {
    ...
    return( 
            <div className="border border-themeGrey1 bg-white rounded-lg">
                <div className="flex mt-5 mx-5 justify-between">
                    <div className="    w-full">
                        ...
                        <div className="ml-7 flex items-center mt-[2px]">
                            ...
                            <p className="text-sm text-themeGrey2 font-[400] ml-[6px]">{location}</p>
                            <div className="w-1 h-1 rounded-full bg-themeGrey4 ml-[6px]"></div>
                ...
                <div className="h-[1px] mx-7 bg-themeGrey1 mt-4"></div>
                <div className="w-full px-12 pt-[18px] pb-5">
                    <div className="flex">
