...
export const Header = () => {
  return (
    <Disclosure
      as="nav"
      className="bg-white shadow-[inset_0px_-1px_0px_rgba(237,237,237,1)]"
    >
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? "bg-themePurple1 text-white"
                            : "text-themeGrey2 hover:bg-[#ccbcf7] hover:text-white",
                  ...
                  <div>
                    <Menu.Button className="flex items-center">
                      ...
                      <div className="ml-[12px] hidden lg:block">
                        <p className="text-themeGrey3 text-xs font-semibold">
                          Esther Howard
                        </p>
                        <p className="text-themeGrey2 text-[10px] font-medium mt-[2px]">
                          ester@gmail.com
                        </p>
                      </div>
                          ...
                          >
                            ...
                            <div className="flex items-center justify-center">
                              ...
                              <div className="ml-[12px]">
                                ...
                                <p className="text-themeGrey4 text-sm mt-[-2px]">
                                  Admin
                                </p>
                              </div>
                            </div>
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            className={classNames(
                              active ? "bg-[#34314d]" : "",
                              "px-4 py-2 text-sm text-white flex items-center"
                            )}
                          >
                            <img
                              alt=""
                              src="/image/icons/setting.svg"
                              alt="setting"
                            />
              ...
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? "bg-themePurple1 text-white"
                      : "text-gray-300 hover:bg-[#ccbcf7] hover:text-white",
